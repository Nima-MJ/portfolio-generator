...
module.exports = templateData => {
  //destructure projects and avout data from templateData based on their property key names
  const {projects, about, ...header} = templateData; // the first two objects would have a name of projects and about asssigned to them respectively
  return `
  <!DOCTYPE html>
  <html lang="en">
